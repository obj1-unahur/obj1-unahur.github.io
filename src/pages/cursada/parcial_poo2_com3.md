...
descripcion: Semana de PARCIAL VIRTUAL para la comisión 3.

ejercicios:
  - name: PRIMER PARCIAL - COMISIÓN 3
    #Poner template correcta del parcial
    urlTemplate: https://github.com/unahur-obj2-2026c1/PlataformaCuracionMusical
    destOrg: unahur-obj2-2026c1
    prefix: parcial1Com3_2026C1
    comentarios:
      - name: Primer parcial para comisión 3
...
- Semana de PARCIAL VIRTUAL para la comisión 3.
