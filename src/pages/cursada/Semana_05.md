...
- ##### Podrán acceder a sus repos tanto desde el link del mail como desde el link de **"Aceptar asignación"** que está en esta página. Desde acá, se les solicitará que ingresen su usuario de github y al aceptar, los dirigirá a la invitación generada para cada ejercicio y podrán aceptar los permisos (tiene vencimiento, no se dejen estar). Después de aceptar y las siguientes veces que quieran acceder a github al ejercicio pueden seguir el mismo procedimiento (desde la página siempre pedirá el usuario). Asegúrense de colocarlo correctamente (mayúsculas, minúsculas, guiones, etc) porque en otro caso no les dará acceso y arrojará error 404.
