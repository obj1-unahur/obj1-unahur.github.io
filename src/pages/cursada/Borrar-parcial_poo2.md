...
descripcion: Semana de PARCIAL VIRTUAL para las comisiones 1 y 2.

ejercicios:
  - name: PRIMER PARCIAL - COMISIÓN 1 y 2
    #Poner template correcta del parcial
    urlTemplate: https://github.com/unahur-obj2/agencia-viajes
    destOrg: unahur-obj2-2026c1
    prefix: parcial1Com1y2_2026C1
    comentarios:
      - name: Primer parcial para comisión 1 y 2
...
- Semana de PARCIAL VIRTUAL para las comisiones 1 y 2.
